...
@section('contant')
    ...
    <section class="forms">
        <div class="container-fluid">
            <!-- Page Header-->
            <header>
                <h1 class="h3 display">Search For Invoice By Property Name </h1>
            </header>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form id="validateForm" method="GET" action="{{route('invoiceCustomData')}}">
                                @csrf
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Choose Customer Name  </label>
                                    <div class="col-sm-10">
                                    <select id="id" name="id">
                                    <option value=""></option>
                                         @foreach($query2 as $value2)

                                             <option value="{{$value2->prop}}"> {{$value2->prop}}</option>
